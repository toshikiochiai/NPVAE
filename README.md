...
The saved data from our training on the DrugBank&Project dataset can be found in the `pre-trained` folder. If you want to use it in the following process, please specify this path. 
