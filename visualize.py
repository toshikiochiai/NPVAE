...
if __name__ == '__main__':
    ...
    parser.add_argument("--prop_info", type=str,
                        default='nplikeness', help="Property information used for learning")
    parser.add_argument("--prepared_path", type=str,
                        default="./created_data", help="The path where the created 'input data' is saved (No need to set if you do not use your own property information)")
